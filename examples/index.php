...
require __DIR__ . '/../src/GameQ3/Autoloader.php';
use GameQ3\GameQ3;
phpinfo();
// Define your servers,
// see list.php for all supported games and identifiers. //"addr":"208.103.169.85:28015","gameport":28010,
$servers = array(
	array(
		'id' => 'RUST',
		'type' => 'rust',
...
function print_table($data) {
	...
	if (!$data['info']['online']) {
		echo "<p>Сервер не ответил в течение указанного времени.</p>\n";
		return;
	}
